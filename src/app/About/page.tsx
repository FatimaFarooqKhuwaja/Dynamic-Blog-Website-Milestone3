  ...
  return (
    <div className="max-w-screen-lg mx-auto px-4 py-12">
      ...
      <div className="mt-12">
        ...
        <p className="text-lg text-gray-700 mt-4">
          Hello! Iam Fatima Farooq Khuwaja, a passionate Frontend Developer with a deep love for building interactive and visually appealing web applications. I am student at GIAIC where I am exploring AgenticAI and GenAI and currently, I am student of class first year.
          <br />
          <br />
